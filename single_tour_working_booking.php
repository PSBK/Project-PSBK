                    ...
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);" class="show-submenu">Home <i class="icon-down-open-mini"></i></a><ul>
                                ...
                                <li><a href="index_8.html">Search bar + Video <img src="img/new.png" alt="" class="pull-right hidden-sm hidden-xs"></a></li>
                                <li><a href="index_9.html">Text Rotator <img src="img/new.png" alt="" class="pull-right hidden-sm hidden-xs"></a></li>
                                <li><a href="index_10.html">Cookie Bar (EU) <img src="img/new.png" alt="" class="pull-right hidden-sm hidden-xs"></a></li>
                                <li><a href="index_11.html">Popup Advert <img src="img/new.png" alt="" class="pull-right hidden-sm hidden-xs"></a></li>
                            </ul>
                        </li>
                        <li class="submenu">
                            ...
                            <div class="menu-wrapper">
                                <div class="col-md-4">
                                    <h3>Pages</h3><ul>
                                        ...
                                        <li><a href="faq.html">Faq <img src="img/new.png" alt="" class="pull-right hidden-sm hidden-xs"></a></li>
                                        <li><a href="pricing_tables.html">Pricing tables <img src="img/new.png" alt="" class="pull-right hidden-sm hidden-xs"></a></li>
                                        <li><a href="page_with_map.html"><i class="icon-map"></i>  Full screen map<img src="img/new.png" alt="" class="pull-right hidden-sm hidden-xs"></a></li>
                                        <li><a href="admin.html"><i class="icon-cog-1"></i>  Admin area <img src="img/new.png" alt="" class="pull-right hidden-sm hidden-xs"></a></li>
                                    </ul>
                                </div>
                                <div class="col-md-4">
                                    <h3>Pages</h3>
                                    <ul>
                                        ...
                                        <li><a href="gallery_3_columns.html">Gallery 3 columns <img src="img/new.png" alt="" class="pull-right hidden-sm hidden-xs"></a></li>
                                        <li><a href="gallery_4_columns.html">Gallery 4 columns <img src="img/new.png" alt="" class="pull-right hidden-sm hidden-xs"></a></li>
                                        <li><a href="timeline.html">Tour timeline <img src="img/new.png" alt="" class="pull-right hidden-sm hidden-xs"></a></li>
                                        <li><a href="general_page.html"><i class="icon-light-up"></i>  Weather Forecast <img src="img/new.png" alt="" class="pull-right hidden-sm hidden-xs"></a></li>
                                    </ul>
                                </div>
                                <div class="col-md-4">
                                    <h3>Elements</h3>
                                    <ul>
                                        ...
                                        <li><a href="footer_2.html"><i class="icon-columns"></i> Footer with working newsletter <img src="img/new.png" alt="" class="pull-right hidden-sm hidden-xs"></a></li>
                                        ...
                                        <li><a href="newsletter_template/newsletter.html" target="blank"><i class=" icon-mail"></i> Responsive email template <img src="img/new.png" alt="" class="pull-right hidden-sm hidden-xs"></a></li>
                                        <li><a href="index.html"><i class="icon-circle color_1"></i> Color version 1</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-sm-3">
                ...
                <a href="/cdn-cgi/l/email-protection#adc5c8c1ddedcec4d9d4d9c2d8dfde83cec2c0" id="email_footer"><span class="__cf_email__" data-cfemail="8fe7eae3ffcfece6fbf6fbe0fafdfca1ece0e2">[email&#160;protected]</span><script data-cfhash='f9e31' type="text/javascript">
